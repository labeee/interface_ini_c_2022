...
function add_vidro(){
	...
	if (erro_vidro == 1){} // não faz nada
		...
		if([u_vidro, fs_vidro].includes('')){
			window.alert('Todos os campos devem ser preenchidos para que o componente seja adicionado')
		}
		else{
...
function add_parede_externa(){
	...
	if (erro_parede == 1){} // não faz nada
		...
		if ([u_parede, ct_parede, ars_parede].includes('')){
			window.alert('Todos os campos devem ser preenchidos para que o componente seja adicionado')
		}
		else{
...
function add_parede_interna(){
	...
	if (erro_parede == 1){} // não faz nada
		...
		if ([u_parede, ct_parede].includes('')){
			window.alert('Todos os campos devem ser preenchidos para que o componente seja adicionado')
		}
		else{
...
function add_cob(){
	...
	if (erro_cob == 1){} // não faz nada
		...
		if ([u_cobertura, ct_cobertura, ars_cobertura].includes('')){
			window.alert('Todos os campos devem ser preenchidos para que o componente seja adicionado')
		}
		else{
...
function add_ac(){
	...
	if (erro_ac == 1){} // não faz nada
		...
		if ([tipo_ac, capacidade_ac, tipo_coeficiente, valor_coeficiente, pot_renovacao].includes('')){
			window.alert('Todos os campos devem ser preenchidos para que o componente seja adicionado')
		}
		else{
